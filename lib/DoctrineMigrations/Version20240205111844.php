 ...
 */
final class Version20240205111844 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VSCAT_Products ADD in_stock INT DEFAULT 0 NOT NULL, ADD tags VARCHAR(255) DEFAULT \'\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_4A491FD507FAB6A ON VSAPP_Settings (maintenance_page_id)');
        $this->addSql('ALTER TABLE VSCAT_Products DROP in_stock, DROP tags');
