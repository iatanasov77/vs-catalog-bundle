 ...
 */
final class Version20250106112754 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE VSCAT_AssociationTypes (id INT AUTO_INCREMENT NOT NULL, association_strategy VARCHAR(255) DEFAULT \'strategy_associated\' NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(64) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_7F20F79077153098 (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE VSCAT_PricingPlanSubscriptions (id INT AUTO_INCREMENT NOT NULL, pricing_plan_id INT DEFAULT NULL, user_id INT DEFAULT NULL, currency_id INT DEFAULT NULL, recurring_payment TINYINT(1) DEFAULT 0 NOT NULL, price NUMERIC(8, 2) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, expires_at DATETIME DEFAULT NULL COMMENT \'Is Updated when create a  New payment for this subscription.\', gateway_attributes JSON DEFAULT NULL, active TINYINT(1) DEFAULT 0 NOT NULL COMMENT \'One Active Subscription for an User and for PaidService. Wnen the Payment succeed set active true and set active false for previous active for this paid service.\', INDEX IDX_EA3E01A029628C71 (pricing_plan_id), INDEX IDX_EA3E01A0A76ED395 (user_id), INDEX IDX_EA3E01A038248176 (currency_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE VSCAT_PricingPlans (id INT AUTO_INCREMENT NOT NULL, currency_id INT DEFAULT NULL, category_id INT NOT NULL, paid_service_id INT NOT NULL, active TINYINT(1) NOT NULL, title VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, premium TINYINT(1) NOT NULL, discount NUMERIC(8, 2) DEFAULT NULL, price NUMERIC(8, 2) DEFAULT \'0.00\' NOT NULL, gateway_attributes JSON DEFAULT NULL, INDEX IDX_615E6C0538248176 (currency_id), INDEX IDX_615E6C0512469DE2 (category_id), INDEX IDX_615E6C0587FFD8A7 (paid_service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE VSCAT_ProductPictures (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, path VARCHAR(255) NOT NULL, original_name VARCHAR(255) DEFAULT \'\' NOT NULL COMMENT \'The Original Name of the File.\', code VARCHAR(255) NOT NULL, INDEX IDX_3A0B8B937E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE VSCAT_Products (id INT AUTO_INCREMENT NOT NULL, currency_id INT DEFAULT NULL, published TINYINT(1) NOT NULL, slug VARCHAR(255) NOT NULL, name VARCHAR(64) NOT NULL, description LONGTEXT DEFAULT NULL, in_stock INT DEFAULT 0 NOT NULL, tags VARCHAR(255) DEFAULT \'\', created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, price NUMERIC(8, 2) NOT NULL, UNIQUE INDEX UNIQ_D8F34E8C989D9B62 (slug), INDEX IDX_D8F34E8C38248176 (currency_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE VSPAY_OrderItem (id INT AUTO_INCREMENT NOT NULL, order_id INT DEFAULT NULL, subscription_id INT DEFAULT NULL, product_id INT DEFAULT NULL, payable_object_type VARCHAR(255) NOT NULL, price NUMERIC(8, 2) NOT NULL, currency_code VARCHAR(8) NOT NULL, qty INT DEFAULT 1 NOT NULL, adjustments_total INT NOT NULL, total INT NOT NULL, product_name LONGTEXT DEFAULT NULL, INDEX IDX_1C9B655C8D9F6D38 (order_id), INDEX IDX_1C9B655C9A1887DC (subscription_id), INDEX IDX_1C9B655C4584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE VSUM_Users ADD customer_group_id INT DEFAULT NULL, ADD payment_details JSON DEFAULT NULL');
